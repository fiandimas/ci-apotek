...
<div class="col-md-6">
	<div class="panel-body">
		<form action="<?= base_url('index.php/ta_apotek/update_cart')?>" method="post">
			<table id="example" class="table table-hover table-striped">					
				<tr>
					<a class="btn btn-danger" href="<?=base_url('index.php/ta_apotek/clear_cart')?>">Clear Cart</a>
						Nama Pembeli : <input type="text" name="nama_pembeli" required style="width: 21%"> Bayar : <input type="number" name="bayaran" style="width: 21%" required>
					<th style="text-align: center">No</th>
					<th style="text-align: center">Nama Obat</th>
					<th style="text-align: center">Harga</th>
				...
				<tr align="center">
					...
					<td><a href="<?=base_url('index.php/ta_apotek/delete_cart/'.$obat['rowid'])?>" class="btn btn-danger">&times;</a></td>
				</tr>
				<?php
					}	
				?>
			...
			<table>
				<tr>
					...
					<td><input type="submit" required class="btn btn-primary" value="Bayar" name="bayar"  style="margin-left: 250px"></td>
				</tr>
			</table>
		</form>
		<br>
